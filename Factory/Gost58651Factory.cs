...
namespace CimBios.Gost58651.Factory;

/// <summary>
/// RF CIM Canonical model classes C# implementation.
/// </summary>
public class Gost58651Factory : ICimDatatypeLibFactory
{
    public ICimDatatypeLib Create()
    {
        var schema = new CimRdfSchemaXmlFactory().CreateSchema();
        schema.Load(new StreamReader("Schemas/GOST_58651.rdfs"));
